...
* `contentbox_default_*` - All [Contentbox](https://www.ortussolutions.com/products/contentbox) "[Geek Settings](https://contentbox.ortusbooks.com/usage/using-contentbox/system/geek-settings)" may be provided as environment variables, allowing granular control of your ContentBox settings.
